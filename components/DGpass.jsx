...
const PasswordPage = () => {
  ...
  const verifyPassword = (e) => {
    ...
    const correctPassword = "dg"; // Access client-side environment variable with prefix
    ...
    if (enteredPassword === correctPassword) {
        toast.success("Redirecting...", {
          ...
          setTimeout(() => {
            window.location.href = "https://drive.google.com/drive/folders/16R8haDZQw1VrbUzWXqu-AX7mecRv8Zog?usp=sharing"; // Replace with your website
  ...
  return (
    ...
    <div className="back-to-portfolio">
        ← Back to Portfolio
                ...
                <h3>Hope & Kendall Big Little Reveal</h3>
              </div>
            </div>
          </div>
          {/* END TITLE */}
