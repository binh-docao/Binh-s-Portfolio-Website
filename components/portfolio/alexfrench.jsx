...
const Portfolio = () => {
    ...
    const verifyPassword = (e) => {
        ...
        const correctPassword = "french";  // Ensure you have the right password
        ...
        if (enteredPassword === correctPassword) {
            ...
            setTimeout(() => {
                window.location.href = "https://drive.google.com/drive/folders/1hWzdf_YLU4ET2HYgsfoMjXBQ2cTAiSQP?usp=sharing"; // Your Google Drive link
