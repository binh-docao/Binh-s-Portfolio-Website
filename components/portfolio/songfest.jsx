...
const Portfolio = () => {
    ...
    const verifyPassword = (e) => {
        ...
        const correctPassword = "first";  // Ensure you have the right password
        ...
        if (enteredPassword === correctPassword) {
            ...
            setTimeout(() => {
                window.location.href = "https://drive.google.com/drive/folders/1lwlXkeLB3mwhNJR7fCBPo-gfTnHDAdK4?usp=sharing"; // Your Google Drive link
    ...
    function importAll(r) {
        return r.keys().map(r);
              ...
              const images = importAll(require.context('../../public/img/portfolio/songfest/centuries/', false, /.jpg$/));
